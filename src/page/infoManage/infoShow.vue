    ...
    <div class="fillcontain">
        ...
        <el-row class="info_row" :gutter="10">
                ...
                <div class="area">
                    <div class="namearea">
                        ...
                        <p>昵称：nice man </p>
                        <p>投资年限：3年</p>
                        <p>绑定邮箱：37xxxxx94@qq.com</p>
                        <p>绑定手机：159xxxxxx92</p>
                ...
                <div class="area">
                    <div class="moneyarea">
                        ...
                        <p class="title"><span class="money">120.00</span><span class="yuan">元</span></p>
                        </div>
                    <div class="chongzhiarea">
                        <img :src="toMPicimg"/>
                        <p class="chongzhi">
                            <el-button type="success" size="">我要借出</el-button>
        ...
        <el-row class="data_row row" :gutter="10">
                ...
                <div class="area">
                    ...
                    <p class="num"><span class="symbol">￥</span>230.00</p>
                ...
                <el-col :span="6">
                    ...
                    <p class="num"><span class="symbol">￥</span>278.00</p>
                ...
                <el-col :span="6">
                    ...
                    <p class="num"><span class="symbol">￥</span>1300.00</p>
                    <a class="detail dbgcolor">查看详情&nbsp;&nbsp;<i class="el-icon-d-arrow-right"></i></a>
                </div>
                </el-col>
                <el-col :span="6">
                <div class="area">
                    ...
                    <p class="num"><span class="symbol">￥</span>1500.00</p>
                    <a class="detail zbgcolor">查看详情&nbsp;&nbsp;<i class="el-icon-d-arrow-right"></i></a>
                </div>
                </el-col>
        </el-row>
    ...
    export default {
        data(){
            return {
               ...
               avatarImg: require('@/assets/img/tom2.jpg'),
