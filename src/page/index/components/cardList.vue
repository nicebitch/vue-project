      ...
      <el-col>
        <el-card :body-style="{ padding: '0px' }" class="cardBody">
          ...
          <div class="progress wflex">
            <div class="rflex">
              <span class="title">vue:</span><el-progress :percentage="80"></el-progress>
            </div>
            <div class="rflex">
            ...
            <div class="rflex">
              <span class="title">react:</span><el-progress :percentage="40"></el-progress>
            </div>
            <div class="rflex">
...
<script>
  import userImg from "@/assets/img/tom2.jpg";
