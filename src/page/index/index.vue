							...
							<el-col :span="12">
								<div class="pay saleBgcolor data_list rflex">
									<div class="leftItem cflex wflex">
										...
										<p class="number">3<span class="perTitle">({{ $t('index.tenMillion') }})</span></p>
									</div>
									<div class="rightItem">
							...
							<el-col :span="12">
								<div class="pay taxBgcolor data_list rflex">
									<div class="leftItem cflex wflex">
										...
										<p class="number">102<span class="perTitle">(%)</span></p>
									</div>
									<div class="rightItem">
							...
							<el-col :span="6">
								<div class="extenedBgcolor data_list rflex">
									<div class="leftItem cflex wflex">
										...
										<p class="number">5<span class="perTitle">({{ $t('index.person') }})</span></p>
							...
							<el-col :span="6">
								<div class="likeBgcolor data_list rflex">
									<div class="leftItem cflex wflex">
										...
										<p class="number">6<span class="perTitle">({{ $t('index.person') }})</span></p>
							...
							<el-col :span="6">
								<div class="linkBgColor data_list rflex">
									<div class="leftItem cflex wflex">
										...
										<p class="number">7<span class="perTitle">({{ $t('index.person') }})</span></p>
										<p class="cardText">Decreased by 40%</p>
									</div>
									<div class="rightItem">
							...
							<el-col :span="6">
								<div class="keleBgColor data_list rflex">
									<div class="leftItem cflex wflex">
										...
										<p class="number">8<span class="perTitle">({{ $t('index.person') }})</span></p>
										<p class="cardText">Decreased by 60%</p>
									</div>
									<div class="rightItem">
